...
Во время проведения конференции Holy JS 2019 в Санкт-Петербурге, я помогу тебе заработать одну из «ачивок» для прохождения квеста.
Для этого тебе нужно показать свои знания WEB разработки в испытании Skill-control. 
